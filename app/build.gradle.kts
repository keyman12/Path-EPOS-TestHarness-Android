...
android {
    ...
    defaultConfig {
        applicationId = "tech.path2ai.epos"
        minSdk = 26
        targetSdk = 35
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    // Path Terminal SDK — added by the agent during integration.
    // The agent will add these dependencies after running path-terminal-init:
